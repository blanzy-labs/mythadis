...
Use this checklist before creating a release for AI Consensus Engine.

## Preflight

- [ ] Confirm working tree is clean.
- [ ] Confirm branch is `main`.
- [ ] Confirm canonical repo name is `ai-consensus`.
- [ ] Confirm display name is AI Consensus Engine.
